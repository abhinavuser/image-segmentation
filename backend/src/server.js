...
// // --- Start Flask app.py as a subprocess using the specified virtualenv ---
// const flaskAppPath = path.resolve(__dirname, '../../ritm_interactive_segmentation/web_demo/app.py');
// const pythonPath = path.resolve(__dirname, '../../ritm_interactive_segmentation/env/bin/python');

// console.log('Starting Flask server:', pythonPath, flaskAppPath);
// const flaskProcess = spawn(pythonPath, [flaskAppPath], {
//   stdio: 'inherit',
